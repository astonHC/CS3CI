...
static void PSO_INIT_PARTICLE(PSO_PARTICLE* PARTICLE, const PSO_BOUND* BOUNDS, int DIMENSIONS)
{
    ...
    for(int INDEX = 0; INDEX < DIMENSIONS; INDEX++)
    {
        ...
        PARTICLE->VELOCITY[INDEX] = VELOCITY_MAX;
    } 
...
static void PSO_UPDATE_PBEST(STATE S, PARTICLE P, int DIMENSIONS)
{
    ...
    else
    {
        P->STAGNATE++;
        PSO_HANDLE(NONE, PSO_ERROR_NONE, 
            "STAGNANT PARTICLE: %d FOUND AT ITERATION: %d\n", 
            P->STAGNATE, S->SWARM.ITERATION);
    }
}
...
void PSO_OPTIMISE(PSO_STATE* STATE)
{
    ...
    for(int INDEX = 0; INDEX < PSO_MAX_PARTICLES; INDEX++)
    {
        ...
        STATE->SWARM.PARTICLES->CURRENT_FITNESS = PSO_DEMAND_FITNESS(STATE->SWARM.PARTICLES->POSITION, &STATE->DATASET);
        PSO_UPDATE_PBEST(STATE, P, STATE->DIMENSIONS);
    }
