...
static void TSP_ACO_ANT_TOUR(TSP_STATE* STATE, TSP_ACO_STATE* ACO_STATE, 
...
// AND ALLOWS EXPLORATION OF NEW SOLUTIONS
...
int TSP_ACO_BASE(TSP_STATE* STATE, int MAX_ITER)
{
    ...
    for(ITERATION = 0; ITERATION < MAX_ITER; ITERATION++)
    {
        ...
        for(int ANT = 0; ANT < TSP_ACO_ANTS; ANT++)
        {
            TSP_ACO_ANT_TOUR(STATE, ACO_STATE, ANT_PATHS[ANT], &ANT_DIST[ANT]);
        }
